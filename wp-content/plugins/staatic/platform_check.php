...
function staatic_platform_check_key_notice() {
    return staatic_platform_check_notice(
        sprintf(
            ...
            __(
                'Staatic for WordPress requires either STAATIC_KEY or AUTH_KEY to be defined within wp-config.php. In order to fix this error, please add the following line to your wp-config.php file and reactivate the plugin: %1$s',
                'staatic',
            ),
