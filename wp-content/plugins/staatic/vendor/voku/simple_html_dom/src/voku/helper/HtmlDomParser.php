...
class HtmlDomParser extends AbstractDomParser
{
    ...
    protected $specialScriptTags = ['text/html', 'text/x-custom-template', 'text/x-handlebars-template'];
     ...
     * @param string $html
     */
    protected function createDOMDocument($html, $libXMLExtraOptions = null) : DOMDocument
    {
