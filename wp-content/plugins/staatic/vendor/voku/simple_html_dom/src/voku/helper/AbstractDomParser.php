...
abstract class AbstractDomParser implements DomParserInterface
{
    ...
    public static abstract function __callStatic($name, $arguments);
     ...
     * @param string $html
     */
    protected abstract function createDOMDocument($html, $libXMLExtraOptions = null) : DOMDocument;
    /**
     ...
     * @param string $selector
     */
    public abstract function findMulti($selector);
    /**
     * @param string $selector
     */
    public abstract function findMultiOrFalse($selector);
    /**
     * @param string $selector
     */
    public abstract function findOne($selector);
    /**
     * @param string $selector
     */
    public abstract function findOneOrFalse($selector);
     ...
     */
    public abstract function html($multiDecodeNewHtmlEntity = \false, $putBrokenReplacedBack = \true) : string;
    /**
     * @param bool $multiDecodeNewHtmlEntity
     * @param bool $putBrokenReplacedBack
     */
     ...
     * @param string $html
     */
    public abstract function loadHtml($html, $libXMLExtraOptions = null) : DomParserInterface;
    /**
     * @param string $filePath
     */
    public abstract function loadHtmlFile($filePath, $libXMLExtraOptions = null) : DomParserInterface;
    /**
     * @param string $filepath
     */
